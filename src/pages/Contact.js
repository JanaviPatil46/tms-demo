...
//     if (contacts.length === 0 || contacts.every(contact => contact.value.trim() !== '')) {
//       const newId = contacts.length;
//       const label = contacts.length === 0 ? 'Primary Contact' : 'Additional Contact';
...
//           <input type="text" id="first_name" value={firstName} onChange={handleFirstNameChange} style={{ width: "100%", padding: "2px", boxSizing: "border-box", border: "1px solid #695cfe", borderRadius: "10px", height: "4vh" }} />
//         </div>
//         <div className="middle-name col-4" style={{ flex: "1", padding: "10px" }}>
//           <label>Middle name</label>
//           <input type="text" id="middle_name col-4" value={middleName} onChange={handleMiddleNameChange} style={{ width: "100%", padding: "2px", boxSizing: "border-box", border: "1px solid #695cfe", borderRadius: "10px", height: "4vh" }} />
//         </div>
//         <div className="last-name col-4" style={{ flex: "1", padding: "10px" }}>
//           <label>Last name</label>
//           <input type="text" id="last_name"value={lastName} onChange={handleLastNameChange} style={{ width: "100%", padding: "2px", boxSizing: "border-box", border: "1px solid #695cfe", borderRadius: "10px", height: "4vh" }} />
//         </div>

//         <div className="col-12" style={{ flexFlow: "wrap", display: "flex", padding: "10px", flexDirection: "column" }}>
//           <label>Contact name</label>
//           <input type="text" id="contact_name" value={contactName} onChange={(e) => setContactName(e.target.value)} style={{ width: "100%", boxSizing: "border-box", border: "1px solid #695cfe", borderRadius: "10px", height: "4vh" }} />
//         </div>
...
//           <FiPlusCircle onClick={addContactInput} style={{ marginRight: "2%" }} />
...
//             />
//           </label>
//           <button className="remove-button" style={{color:"red",background:'none'}} onClick={() => removeContactInput(contact.id)}>
//             <FaTrash /> 
//           </button>
//         </div>
//       ))}

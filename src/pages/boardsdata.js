const boardsData = [
    ...
    { id: 'board1', title: 'Contract+organizer+new client retainer', cards: [
    ...
    { id: 'board2', title: 'Create Invoice(New/Existing)', cards: [
    ...
    { id: 'board7', title: "Sudheer's Clients", cards: [] },
    { id: 'board7', title: "Missing Info", cards: [] },

    { id: 'board6', title: "Needs Extensions", cards: [] },
    { id: 'board7', title: "Team lead Review", cards: [] },
    { id: 'board7', title: "Mgr Review", cards: [] },
